    ...
    public static class SwaggerExtension
    {
        public static IServiceCollection AddCustomizedSwagger(this IServiceCollection services, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                services.AddSwaggerGen(c =>
                {
                    ...
                    {
                        Version = "v1",
                        Title = "ASPNET Core AcmeCorp Project",
                        Description = "",
                        Contact = new OpenApiContact { Name = "Xinh Nguyen", Email = "nguyentrucxjnh@gmail.com", Url = new Uri("https://ntxinh.github.io/") },
                        License = new OpenApiLicense() { Name = "MIT", Url = new Uri("https://github.com/ntxinh/AspNetCore-AcmeCorp/blob/master/LICENSE") }
                    });
        ...
        public static IApplicationBuilder UseCustomizedSwagger(this IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ASPNET Core AcmeCorp Project API v1.0");
                    c.SwaggerEndpoint("/swagger/v2/swagger.json", "ASPNET Core AcmeCorp Project API v2.0");
