...
using AcmeCorp.Infra.CrossCutting.Identity.Data;
using AcmeCorp.Infra.CrossCutting.Identity.Models;
using AcmeCorp.Infra.CrossCutting.Identity.Models.AccountViewModels;
...
namespace AcmeCorp.Services.Api.Controllers.v2
{
    [Authorize]
    [ApiVersion("2.0")]
